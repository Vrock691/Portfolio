...
export default function ProjectCard({
    ...
    return (
        <div className="w-full my-8 flex flex-row gap-3 md:flex-row">
            ...
            <div>
                ...
                </div>
                {
                    ...
                    ?   <button className="flex flex-wrap mt-2" onClick={(e) => changePeopleVisibility(true)}>
                ...
                <ul className="flex flex-wrap items-center mt-2 gap-4">
                    {
